      ...
      <ul className="flex flex-wrap gap-2">
        <li>
          <a
            ...
            title="Verify the Sablier Lockup program on Solscan"
...
export default function Home() {
  // Single program ID per deployment (devnet and mainnet share the address).
  // Always point at the SolSab Lockup program on Solscan.
  const sablierExplorerUrl = explorerAccount(SABLIER_LOCKUP_PROGRAM_ID);
                ...
                <ol className="space-y-5 text-muted leading-relaxed">
                  <li className="flex gap-4">
                    ...
                    <span>
                      ...
                      on Solscan. Verified bytecode, immutable account data.
                    </span>
                  </li>
                  <li className="flex gap-4">
                    <span className="text-cyan tabular font-semibold shrink-0 w-6">02</span>
                    <span>
                      Confirm there is no RipGuard custody program. RipGuard
                      doesn&apos;t deploy any custom Solana programs.
                    </span>
                  </li>
                  <li className="flex gap-4">
        ...
        <section className="px-5 sm:px-8 py-28 sm:py-40 border-t border-line">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-12 space-y-5 text-lg text-muted leading-relaxed max-w-[58ch]">
              <p>
                Split from your deposit during stream creation and sent directly
                to the RipGuard treasury. One transaction, two instructions, the
                fee transfer and the lock both visible on-chain. Shown before
                you sign.
              </p>
              <p className="text-sm text-faint">
                No hidden withdraw fees. No subscriptions. No yield cuts. Every
                fee is visible on-chain in your own lock transaction&apos;s
                pre-transfer instruction.
              </p>
            </div>
          </div>
        </section>
