...
function FAQItem({
  ...
  return (
    <details className="group border border-white/[0.06] rounded-2xl bg-white/[0.02] hover:border-white/[0.12] transition-colors">
      <summary className="cursor-pointer px-6 py-5 font-semibold text-white/90 list-none flex items-center justify-between text-[15px]">
        {question}
        <svg
      ...
      <div className="px-6 pb-6 text-sm text-white/50 space-y-3 leading-relaxed">
        {children}
      </div>
    </details>
  );
      ...
      <main className="flex-1 flex flex-col">
        ...
        <section className="relative flex flex-col items-center justify-center px-5 sm:px-8 pt-28 sm:pt-40 pb-32 sm:pb-44 overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center gap-8 max-w-4xl">
            ...
            <p className="text-base sm:text-lg text-white/45 text-center max-w-lg leading-relaxed">
        ...
        <section className="px-5 sm:px-8 py-24 sm:py-32 section-divider">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <div className="text-white/40 space-y-5 text-base sm:text-lg leading-relaxed">
              <p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
              {Object.entries(PRESETS).map(([key, preset]) => (
                <Link
                  ...
                  className="card-gradient rounded-2xl p-7 text-center group flex flex-col items-center gap-4"
                >
                  <div className="w-14 h-14 rounded-full border border-cyan/15 bg-cyan/[0.06] flex items-center justify-center group-hover:border-cyan/30 group-hover:bg-cyan/10 transition-all">
                    {PRESET_ICONS[key]}
                  </div>
                  <h3 className="font-semibold text-lg group-hover:text-cyan transition-colors">
                    {preset.label}
                  </h3>
                  <p className="text-sm text-white/40 leading-relaxed">{preset.description}</p>
                </Link>
              ))}
            </div>
              ...
              {[
                ...
                <div key={item.title} className="flex gap-4 card-gradient rounded-xl p-5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/35 mt-1.5 leading-relaxed">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section className="px-5 sm:px-8 py-24 sm:py-28 section-divider">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="card-gradient rounded-2xl p-7 space-y-5">
                <h3 className="font-semibold text-cyan flex items-center gap-2">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
                  We can
                </h3>
                <ul className="text-sm text-white/45 space-y-3">
                  <li>Show you a clean UI for creating Sablier locks</li>
                  <li>Collect the 0.5% fee shown before you sign</li>
                  <li>Shut down the site (your locks still work)</li>
                </ul>
              </div>
              <div className="card-gradient rounded-2xl p-7 space-y-5">
                ...
                <ul className="text-sm text-white/45 space-y-3">
                  ...
                  <li>Withdraw early on your behalf</li>
                  <li>Change unlock rules after lock</li>
                  <li>Move funds anywhere except your wallet</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="px-5 sm:px-8 py-24 sm:py-28 section-divider">
          <div className="max-w-3xl mx-auto text-center space-y-7">
            ...
            <div className="text-white/45 space-y-4 leading-relaxed">
              <p>
        ...
        <section className="px-5 sm:px-8 py-28 sm:py-40 section-divider relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl mx-auto text-center space-y-7">
            <p className="text-sm text-white/30 border border-white/[0.06] rounded-xl px-5 py-3.5 inline-block bg-white/[0.02]">
            ...
            <Link
              href="/create"
              className="inline-block bg-cyan text-black font-bold rounded-xl px-10 py-4 text-lg hover:bg-cyan/90 transition-all hover:shadow-[0_0_40px_rgba(0,229,255,0.35)] active:scale-[0.98]"
            >
              Create a Lock
            </Link>
          </div>
        ...
        {/* Footer */}
        <footer className="px-5 sm:px-6 py-10 section-divider text-center space-y-4">
          ...
          <p className="text-xs text-white/15 max-w-md mx-auto leading-relaxed">
            Do not deposit what you can&apos;t afford to lose.
