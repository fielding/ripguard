...
// Block when Sablier Lockup v2.0 was deployed on Base
...
// inside the commonParams struct. We use this to identify RipGuard streams.
...
async function tvl(api) {
  ...
  // commonParams is a struct tuple — shape is the last field (index 8)
